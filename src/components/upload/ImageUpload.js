...
const ImageUpload = ({ username }) => {
    ...
    const handleUpload = () => {    
        ...
        uploadTask.on(
            ...
            //download from strorage and add to database collection which then will automatically update in the ui 
            () => {
                storage
                    .ref("images")
                    .child(image.name)
